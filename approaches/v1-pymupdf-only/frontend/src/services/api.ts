...
const api = axios.create({ baseURL: API_URL, timeout: 300_000 });
...
export const ttsApi = {
  ...
  generateSegment: async (docId: string, index: number, voiceId = "en-US-AriaNeural", speed = 1.0): Promise<SegmentGenRes> =>
